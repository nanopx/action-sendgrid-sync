...
exports.deleteTemplateVersion = exports.activateTemplateVersion = exports.createTemplateVersion = exports.deleteTemplate = exports.updateTemplate = exports.createTemplate = exports.fetchTemplate = exports.fetchTemplates = exports.setClient = exports.setupClient = void 0;
const axios_1 = __importDefault(__webpack_require__(545));
const TEMPLATE_GENERATION = 'dynamic';
let client;
const setupClient = (apiKey) => {
...
const fetchTemplates = () => __awaiter(void 0, void 0, void 0, function* () {
    if (process.env.NODE_ENV === 'test')
        return { templates: [] };
    const { data } = yield getClient().get(`/templates`, {
        params: { generations: TEMPLATE_GENERATION }
    });
    return data;
});
exports.fetchTemplates = fetchTemplates;
const fetchTemplate = (templateId) => __awaiter(void 0, void 0, void 0, function* () {
    const { data } = yield getClient().get(`/templates/${templateId}`);
    return data;
});
exports.fetchTemplate = fetchTemplate;
const createTemplate = (name) => __awaiter(void 0, void 0, void 0, function* () {
    const { data } = yield getClient().post(`/templates`, {
        name,
...
const updateTemplate = (templateId, name) => __awaiter(void 0, void 0, void 0, function* () {
    const { data } = yield getClient().patch(`/templates/${templateId}`, { name });
    return data;
});
exports.updateTemplate = updateTemplate;
const deleteTemplate = (templateId) => __awaiter(void 0, void 0, void 0, function* () {
    return yield getClient().delete(`/templates/${templateId}`);
});
exports.deleteTemplate = deleteTemplate;
const createTemplateVersion = (templateId, params) => __awaiter(void 0, void 0, void 0, function* () {
    const { data } = yield getClient().post(`/templates/${templateId}/versions`, params);
    return data;
});
exports.createTemplateVersion = createTemplateVersion;
const activateTemplateVersion = (templateId, versionId) => __awaiter(void 0, void 0, void 0, function* () {
    const { data } = yield getClient().patch(`/templates/${templateId}/versions/${versionId}`, { active: 1 });
    return data;
});
exports.activateTemplateVersion = activateTemplateVersion;
const deleteTemplateVersion = (templateId, versionId) => __awaiter(void 0, void 0, void 0, function* () {
    const { data } = yield getClient().delete(`/templates/${templateId}/versions/${versionId}`);
    return data;
});
exports.deleteTemplateVersion = deleteTemplateVersion;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.sync = void 0;
const sendgrid_1 = __webpack_require__(189);
const getTemplateVersionNames = (template) => {
    return template.versions.map(v => v.name).sort((a, b) => a.localeCompare(b));
};
const getNextVersion = (template) => {
...
const getOutdatedVersions = (template, preserveVersions) => {
...
const defaultLogger = (message, dryRun) => {
    // eslint-disable-next-line no-console
    console.log(`${dryRun ? '[DRY RUN] ' : ''}${message}`);
};
const sync = ({ created, updated, deleted, renamed }, templateMap, { templatePrefix = '', subjectTemplate = '{{ subject }}', preserveVersions = 2, dryRun = false, logger = defaultLogger } = {}) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield Promise.all(updateVersionTemplates.map((t) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        logger(`  - Creating new version for template: ${name} (${nextVer})`, dryRun);
        if (dryRun) {
            return Promise.resolve();
        }
